...
const symlinkPath = path.resolve(dataPath, "modules", "sf2e-mechanic");
...
if (symlinkStats) {
    ...
    const proceed = (
        await prompts({
            ...
            name: "value",
            initial: false,
            message: `A "sf2e-mechanic" ${atPath} already exists in the "systems" subfolder. Replace with new symlink?`,
        })
    ).value;
    if (!proceed) {
